...
@section('conteudo')
    {{-- UF-07 (GAP-V1-01) - fila de Recebidos sob a identidade visual do TEMA V1 (14.6.1).
    Filtra exclusivamente status = 'recebido', ordenado por recebido_em desc.
    Mesmo padrao de composicao de tabela, cabecalho e classes de destaque do 14.6.1. --}}
    <p class="title-icone title-icone-status-v1 fl">
        <img src="{{ asset('images/tema-v1/recebido.png') }}" alt="" width="50" height="50">
    </p>
